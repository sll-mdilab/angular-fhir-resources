    ...
    return {
      ...
      getOrdersForPatient: function (patient) {
        ...
        return $http({
          ...
          return Utilities.getFhirResourceList(response);
        });
      },
      /**
       * Create new Order.
       ...
       * @returns { date: {}, subject: { reference: {} }, source: { reference: {} }, detail : [{ reference: {} }],
       *            extension: [{ url: "http://sll-mdilab.net/fhir/Order#alarmlimits", extension: [{ url: upper, valueDecimal: {} }, { url: lower, valueDecimal: {} }] }] }
       */
